        ...
        $.ajax({
            ...
            complete: function (result) {
                ...
                if(result.responseText == 1){
                    location.href = "/xpoval/admin";
                }
                if(result.responseText == 0){
                    $(".erreur_connexion p").text("Cher administrateur, votre mot de passe est incorrect.");
                    $(".erreur_connexion").show();
                    console.log("Cher administrateur, votre mot de passe est incorrect.");
                }
                if(result.responseText == -1){
                    $(".erreur_connexion p").text("Tututut ! Cet espace est réservé aux administrateurs du site.");
                    $(".erreur_connexion").show();
                    console.log("Tututut ! Cet espace est réservé aux administrateurs du site.");
                }
            }
        });
    });
